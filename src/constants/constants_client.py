...
class CLIENT_LOGS:
    ...
    SERVER_ACK = '[LOG] Server acknowledged fragment {seq_num}'
    SERVER_NACK = '[LOG] Server requested retransmission for fragment {seq_num}'
    ...
    WAIT_DISCONNECT_ACK = '[LOG] Waiting for server acknowledgment...'
    SERVER_DISCONNECT_ACK = '[LOG] Server acknowledged disconnect. Closing socket...'
